...
chords, abstract_grammars = get_musical_data('data/Faded.mid')
...
def generate_music(inference_model, corpus = corpus, abstract_grammars = abstract_grammars, tones = tones, tones_indices = tones_indices, indices_tones = indices_tones, T_y = 200, max_tries = 10000, diversity = 1):
    """
    ...
    out_stream.insert(0.0, tempo.MetronomeMark(number=150))
